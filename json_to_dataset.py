...
if __name__ == '__main__':
    jpgs_path   = "FF_Datasets/JPEGImages"
    pngs_path   = "FF_Datasets/SegmentationClass"
    classes     = ["_background_","FFUnit"]
    # classes     = ["_background_","cat","dog"]
    
    count = os.listdir("./FF_Datasets/bigpng/") 
    for i in range(0, len(count)):
        path = os.path.join("./FF_Datasets/bigpng", count[i])
